...
var SpeciesService = /** @class */ (function () {
    ...
    SpeciesService.prototype.getSpecies = function () {
        ...
        return this.http.get(this.speciesUrl)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (_) { return _this.unit.log('Spec Serv :: Species Gotten'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getSpecies', [])));
    };
    SpeciesService.prototype.getSpec = function (id) {
        this.unit.log("Spec Serv :: Spec Gotten");
        // NEEDS ATTRIBUTES HERE
        //return of(this.species.find(spec => spec.id === id))
...
var SpeciesComponent = /** @class */ (function () {
    ...
    SpeciesComponent.prototype.revealSpecies = function (spec) {
        ...
        // if (this.species[ind].attributes == null){
        //     var sendData = {
